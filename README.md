...
The reference configuration targets an ATtiny85 at 1 MHz. Select the matching clock and fuse settings in the Arduino IDE according to the installed board core and hardware.
